 ...
 * <p>
 * <h2>Limitations</h2>
 * Please note that the {@link WifiDirectServiceConnectionEngine}
 ...
 */
public class WifiDirectServiceConnectionEngine
{
     ...
     */
    private static WifiDirectServiceConnectionEngine instance;
     ...
     * @return The instance
     */
    public static WifiDirectServiceConnectionEngine getInstance()
    {
        if (instance == null)
        {
            instance = new WifiDirectServiceConnectionEngine();
        }
        return instance;
    }
     ...
     */
    private WifiDirectServiceConnectionEngine()
    {
    ...
    public void unregisterService()
    {
        ...
        {
            Log.e(TAG, "unregisterService: no service registered to stop");
            ...
            this.manager.requestGroupInfo(this.channel, group ->
            {
                if (group != null && manager != null && channel != null)
                {
                    manager.removeGroup(channel, new WifiP2pManager.ActionListener()
                    {
                        ...
                        {
                            WifiDirectServiceConnectionEngine.logReason(TAG, "disconnectFromGroup: failed to disconnect ", reason);
                        }
                    });
                }
            });
     ...
     * The TCPChannelMaker which is either starting a client socket
     * or has a TCP Server Socket which should accept the clients connection
     */
