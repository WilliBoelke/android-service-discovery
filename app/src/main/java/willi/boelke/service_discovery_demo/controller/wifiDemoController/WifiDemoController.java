...
import willi.boelke.services.serviceConnection.wifiDirectServiceConnection.WifiDirectServiceConnectionEngine;
...
public class WifiDemoController implements WifiDirectPeer
{
    ...
    {
        this.isStarted = true;
        WifiDirectServiceConnectionEngine.getInstance().registerService(this.description, this);
    }
    ...
    public void stop()
    {
        ...
        WifiDirectServiceConnectionEngine.getInstance().unregisterService();
        WifiDirectServiceConnectionEngine.getInstance().stopDiscovery();
        for (WifiConnection connection : connections)
        {
            connection.close();
        }
        WifiDirectServiceConnectionEngine.getInstance().disconnectFromGroup();
        try
        {
